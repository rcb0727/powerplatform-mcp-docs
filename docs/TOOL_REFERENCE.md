...
Generated from the live registry by `npm run docs:tools`; do not edit by hand.
Read the relevant sections on demand. All descriptions are preserved; use
the connected server's current input schemas when making calls.
